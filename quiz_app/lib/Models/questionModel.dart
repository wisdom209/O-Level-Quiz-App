class QuestionModel {
  ...
  initializeData() {
    try {
      ...
      question = questionData['questions']['1978']["${index + 1}"]["question"];
      optionA = questionData['questions']['1978']["${index + 1}"]['a'];
      optionB = questionData['questions']['1978']["${index + 1}"]['b'];
      optionC = questionData['questions']['1978']["${index + 1}"]['c'];
      optionD = questionData['questions']['1978']["${index + 1}"]['d'];
      optionE = questionData['questions']['1978']["${index + 1}"]['e'];
      answer = questionData['questions']['1978']["${index + 1}"]['answer'];
      image = questionData['questions']['1978']["${index + 1}"]['image'];
    }
  }
}
